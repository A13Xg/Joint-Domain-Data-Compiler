...
// format against the public-domain USGS sample corpus in test/fixtures/,
...
import { FIXTURES as BASE, INVALID_FIXTURES as INVALID } from './helpers/fixtures.ts'
...
// --- EAG ---------------------------------------------------------------
{
  ...
  // Midnight crossing is asserted properly in eag-geographic.ts; the check that
  // used to sit here allowed both of its own outcomes and so proved nothing.
